  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto text-white">
        ...
        <h1 className="text-4xl font-bold text-center text-accent mb-12">Suffering</h1>
        ...
        <div className="space-y-6">
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-4 text-accent">Finding Purpose</h2>
          <p>
          ...
          <p>
            As an adherent of Prototheism, a sense of purpose should include contemplation and critical analysis of Prototheism itself, as detailed in the <Link to="/prototheism/purpose" className="text-accent hover:underline">Purpose tenet</Link>.
          </p>

          <h2 className="text-2xl font-semibold mt-12 mb-4 text-accent">Building Community</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-4 text-accent">Developing Emotional Intelligence</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-4 text-accent">Cultivating Mindfulness</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-4 text-accent">Challenging Distorted Thinking</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-4 text-accent">Practicing Self-Compassion</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-4 text-accent">Exercising Creativity</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-4 text-accent">Self Exploration through Altered States of Consciousness</h2>
          <p>
