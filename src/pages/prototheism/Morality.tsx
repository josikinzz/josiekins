        ...
        <div className="max-w-3xl mx-auto text-white">
          ...
          <div className="bg-black/20 backdrop-blur-md border border-white/5 rounded-3xl p-8 md:p-10 shadow-xl">
            <div className="space-y-6 text-lg font-light leading-relaxed text-white/90">
              ...
              <h2 className="text-2xl font-bold mt-12 mb-6 text-accent uppercase tracking-wide border-b border-white/10 pb-2 inline-block">Novel Complexity vs. Destruction</h2>
              <p>
              ...
              <ul className="space-y-2 ml-4">
                <li className="flex items-start gap-3"><span className="text-accent mt-1">•</span><span className="text-white font-medium">Pursuing scientific knowledge and technological advancements</span></li>
                <li className="flex items-start gap-3"><span className="text-accent mt-1">•</span><span className="text-white font-medium">Engaging in creative endeavors and artistic expression</span></li>
                <li className="flex items-start gap-3"><span className="text-accent mt-1">•</span><span className="text-white font-medium">Promoting biodiversity and protecting ecosystems</span></li>
              </ul>
              <p>
                Conversely, examples of actions that destroy or suppress novel complexity include:
              </p>
              <ul className="space-y-2 ml-4">
                <li className="flex items-start gap-3"><span className="text-accent mt-1">•</span><span className="text-white font-medium">Engaging in unsustainable practices that harm the environment</span></li>
                <li className="flex items-start gap-3"><span className="text-accent mt-1">•</span><span className="text-white font-medium">Censoring or restricting access to information and ideas</span></li>
                <li className="flex items-start gap-3"><span className="text-accent mt-1">•</span><span className="text-white font-medium">Promoting monocultures or homogenization of systems</span></li>
                <li className="flex items-start gap-3"><span className="text-accent mt-1">•</span><span className="text-white font-medium">Stifling creativity and individual expression</span></li>
              </ul>
              <p>
                These actions are considered detrimental to the primary moral imperative of increasing novel complexity.
              </p>

              <h2 className="text-2xl font-bold mt-12 mb-6 text-accent uppercase tracking-wide border-b border-white/10 pb-2 inline-block">Suffering vs. Well being</h2>
              <p>
              ...
              <h2 className="text-2xl font-bold mt-12 mb-6 text-accent uppercase tracking-wide border-b border-white/10 pb-2 inline-block">Freedom vs. Subjugation</h2>
              <p>
