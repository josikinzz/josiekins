  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto text-white">
        ...
        <h1 className="text-4xl font-bold text-center text-accent mb-12">Morality</h1>
        ...
        <div className="space-y-6">
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-4">Novel Complexity vs. Destruction</h2>
          <p>
          ...
          <ul className="list-disc list-inside space-y-2 ml-4">
            <li><span className="text-accent font-bold">Pursuing scientific knowledge and technological advancements</span></li>
            <li><span className="text-accent font-bold">Engaging in creative endeavors and artistic expression</span></li>
            <li><span className="text-accent font-bold">Promoting biodiversity and protecting ecosystems</span></li>
          </ul>
          <p>
            Conversely, examples of actions that destroy or suppress novel complexity include:
          </p>
          <ul className="list-disc list-inside space-y-2 ml-4">
            <li><span className="text-accent font-bold">Engaging in unsustainable practices that harm the environment</span></li>
            <li><span className="text-accent font-bold">Censoring or restricting access to information and ideas</span></li>
            <li><span className="text-accent font-bold">Promoting monocultures or homogenization of systems</span></li>
            <li><span className="text-accent font-bold">Stifling creativity and individual expression</span></li>
          </ul>
          <p>
            These actions are considered detrimental to the primary moral imperative of increasing novel complexity.
          </p>

          <h2 className="text-2xl font-semibold mt-12 mb-4">Suffering vs. Well being</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-4">Freedom vs. Subjugation</h2>
          <p>
