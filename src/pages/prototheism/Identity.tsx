  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto text-white">
        ...
        <h1 className="text-4xl font-bold text-center text-accent mb-12">Identity</h1>
        ...
        <div className="space-y-6">
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-4 text-accent">1. Total absence of attributed identity</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-4 text-accent">2. Self-contained separate identity</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-4 text-accent">3. Unity between the self and specific external systems</h2>
          <p>
          ...
          <ul className="list-disc list-inside space-y-2 ml-4">
            <li><span className="text-accent font-bold">Becoming unified with and identifying with a specific object that one is interacting with, such as riding a bicycle.</span></li>
            <li><span className="text-accent font-bold">Becoming unified with and identifying with another person or multiple people. This may happen during intimacy or when in a well-unified team performing tasks that require intense collaboration to succeed.</span></li>
            <li><span className="text-accent font-bold">Becoming unified with and identifying with large crowds of people. This is particularly common at raves, music festivals, and religious events.</span></li>
          </ul>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-4 text-accent">4. Identifying with all perceivable external systems</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-4 text-accent">5. Identifying with all known external systems</h2>
          <p>
          ...
          <ul className="list-disc list-inside space-y-2 ml-4">
            <li><span className="text-accent font-bold">A perspective which feels personally responsible for the self-designing, planning, and implementation of every single specific detail and plot element of one's personal life, the history of humanity, and the Universe as a whole. This naturally includes personal responsibility for humanity's sufferings and its flaws, but also includes its acts of love and achievements.</span></li>
            <li><span className="text-accent font-bold">The sudden and total acceptance of death as a fundamental component of one's life. This is because death is no longer felt to be the destruction of oneself but simply the end of this specific point of conscious awareness, the vast majority of which has always existed and will continue to exist and live on through everything else in which it resides.</span></li>
            <li><span className="text-accent font-bold">The subjective perspective that one's conception of "god" or "godhood" is identical or similar to the nature of existence and the totality of its contents, including oneself.</span></li>
          </ul>

          <h2 className="text-2xl font-semibold mt-12 mb-4 text-accent">Understanding the Illusion</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-4 text-accent">Multiple Identities</h2>
          <p>
