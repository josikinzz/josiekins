...
export function MJV5() {
  return (
    ...
    >
      ...
      <h1 className="text-4xl font-bold text-center text-accent mb-8">Midjourney V5</h1>
      <p className="text-right text-white/80 max-w-3xl mx-auto mb-4 text-lg"><em>~March 2023</em></p>
